...
final class Version20190928200659 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        if ($databasePlatform === 'mysql') {
            ...
            $this->addSql('CREATE TABLE sylius_refund_shop_billing_data ( id SERIAL PRIMARY KEY, company VARCHAR(255), tax_id VARCHAR(255), country_code VARCHAR(255), street VARCHAR(255), city VARCHAR(255), postcode VARCHAR(255), id_credit_memo VARCHAR(255) NOT NULL )');
            $this->addSql('CREATE TABLE sylius_refund_customer_billing_data ( id SERIAL PRIMARY KEY, customer_name VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, postcode VARCHAR(255) NOT NULL, country_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, company VARCHAR(255), province_name VARCHAR(255), province_code VARCHAR(255), id_credit_memo VARCHAR(255) NOT NULL )');

            $this->addSql('CREATE TABLE sylius_refund_embeddable_backup ( id SERIAL PRIMARY KEY, id_credit_memo VARCHAR(255) NOT NULL, channel_code VARCHAR(255) NOT NULL, from_customer_name VARCHAR(255) NOT NULL, from_street VARCHAR(255) NOT NULL, from_postcode VARCHAR(255) NOT NULL, from_country_code VARCHAR(255) NOT NULL, from_city VARCHAR(255) NOT NULL, from_company VARCHAR(255), from_province_name VARCHAR(255), from_province_code VARCHAR(255), to_company VARCHAR(255), to_tax_id VARCHAR(255), to_country_code VARCHAR(255), to_street VARCHAR(255), to_city VARCHAR(255), to_postcode VARCHAR(255) )');
            $this->addSql(' INSERT INTO sylius_refund_embeddable_backup (id_credit_memo, channel_code, from_customer_name, from_street, from_postcode, from_country_code, from_city, from_company, from_province_name, from_province_code, to_company, to_tax_id, to_country_code, to_street, to_city, to_postcode) SELECT id, channel_code, from_customerName, from_street, from_postcode, from_countryCode, from_city, from_company, from_provinceName, from_provinceCode, to_company, to_taxId, to_countryCode, to_street, to_city, to_postcode FROM sylius_refund_credit_memo ');
            ...
            $this->addSql('
                UPDATE sylius_refund_credit_memo
                SET channel_id = sylius_channel.id
                FROM sylius_channel
                INNER JOIN sylius_refund_embeddable_backup ON sylius_channel.code = sylius_refund_embeddable_backup.channel_code
                WHERE sylius_refund_credit_memo.id = sylius_refund_embeddable_backup.id_credit_memo
            ');
            $this->addSql('
                INSERT INTO sylius_refund_shop_billing_data (company, tax_id, country_code, street, city, postcode, id_credit_memo)
                SELECT to_company, to_tax_id, to_country_code, to_street, to_city, to_postcode, id_credit_memo
            ...
            $this->addSql('
                UPDATE sylius_refund_credit_memo
                SET to_id = sylius_refund_shop_billing_data.id
                FROM sylius_refund_shop_billing_data
                WHERE sylius_refund_credit_memo.id = sylius_refund_shop_billing_data.id_credit_memo
            ');
            $this->addSql('ALTER TABLE sylius_refund_shop_billing_data DROP COLUMN id_credit_memo');
            $this->addSql('
            ...
            $this->addSql('
                UPDATE sylius_refund_credit_memo
                SET from_id = sylius_refund_customer_billing_data.id
                FROM sylius_refund_customer_billing_data
                WHERE sylius_refund_credit_memo.id = sylius_refund_customer_billing_data.id_credit_memo
            ');
    ...
    public function down(Schema $schema): void
    {
        ...
        if ($databasePlatform === 'mysql') {
            ...
            $this->addSql('DROP INDEX UNIQ_5C4F333178CED90B');
            $this->addSql('DROP INDEX UNIQ_5C4F333130354A65');
            $this->addSql('DROP INDEX IDX_5C4F333172F5A1AA');
            $this->addSql('ALTER TABLE sylius_refund_credit_memo ADD channel_code VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD channel_name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD channel_color VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD from_customerName VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD from_street VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD from_postcode VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD from_countryCode VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD from_city VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD from_company VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD from_provinceName VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD from_provinceCode VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD to_company VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD to_taxId VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD to_countryCode VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD to_street VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD to_city VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, ADD to_postcode VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, DROP from_id, DROP to_id, DROP channel_id ');
        }
    }
}
